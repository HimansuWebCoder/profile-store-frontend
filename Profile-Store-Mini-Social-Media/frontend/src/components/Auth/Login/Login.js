...
function submitHandler() {
	...
	return (
		<div className="max-w-[500px] m-auto mt-5 p-5 h-auto bg-[#222831] flex justify-center flex-col text-center">
		<div className="w-full  h-5 flex justify-end">
		    	<div className="w-[30px] h-[30px] rounded-full border"></div>
		    </div>
